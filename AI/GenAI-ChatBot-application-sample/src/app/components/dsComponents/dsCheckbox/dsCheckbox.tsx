...
import OkIcon from "@/app/svgs/ok.svg";
...
export interface DsCheckboxProps extends Omit<DsComponentProps<CheckboxVariants>, 'onClick'>, DsSelectableComponent<HTMLInputElement> {
