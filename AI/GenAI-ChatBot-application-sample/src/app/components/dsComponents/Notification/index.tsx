...
import Error from '@/app/svgs/error.svg';
import Warning from '@/app/svgs/warning.svg';
import Success from '@/app/svgs/success.svg';
import Close from '@/app/svgs/close.svg';
import Info from '@/app/svgs/info.svg';
