...
import { DsComponentProps, TriggerType } from "../dsTypes";
import { DsTypography } from "../dsTypography/dsTypography";
import { DsBaloon } from "../baloon/dsBaloon";
import TooltipIcon from '@/app/svgs/info.svg';
...
export interface DsTooltipInfoProps extends Omit<DsComponentProps, 'message' | 'isLoading' | 'variant'> {
    children?: ReactNode,
    icon?: JSX.Element,
    trigger?: TriggerType,
...
export const DsTooltipInfo = forwardRef<HTMLDivElement, DsTooltipInfoProps>(({
    ...
    usePosition(thisRef, ballonRef, position);
