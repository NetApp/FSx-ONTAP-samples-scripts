...
import BaloonIcon from "@/app/svgs/chatbot/baloon.svg";
import ContextMenuIcon from '@/app/svgs/chatbot/actionMenu.svg';
...
const HistoryItem: FunctionComponent<HistoryItemProps> = ({ chatId, history, selectedChatId, onClick, knowledgeBaseId }) => {
    ...
    const dropDownItems = useMemo((): DsDropDownListItemProps[] => {
        ...
        return items;
    }, [setDialog, chatId, historyItem.question, knowledgeBaseId]);
