...
variable "fsxn_password" {
  description = "Default FSxAdmin Password"
  type        = string
  sensitive   = true
}
...
variable "ad_admin_password" {
  description = "Default AD Admin Password"
  type        = string
  sensitive   = true
}
...
variable "ad_security_group_ingress_config" {
  default = [
    {
      description      = "ADDC Port - 88"
      port             = 88
      protocol         = "TCP"
      cidr_blocks      = ["10.0.0.0/16"]
      ipv6_cidr_blocks = ["::/0"]
